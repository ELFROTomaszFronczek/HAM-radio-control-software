...
namespace Omnirig_CAT
{
    public class SevenSegment : UserControl
    {
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            if (Parent != null)
            {
                InvokeOnClick(Parent, new EventArgs());
            }
        }
        ...
        bool dDot;
        public bool DoubleDot { get { return dDot; } set { dDot = value; Invalidate(); } }
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "SevenSegment";
            this.Load += new System.EventHandler(this.SevenSegment_Load);
            this.ResumeLayout(false);
        ...
        private void SevenSegment_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (!dDot)
            {
                ...
                if (showDot)
                    e.Graphics.FillEllipse(dotOn ? brushLight : brushDark, 1, gridHeight - elementWidth + 1, elementWidth, elementWidth);
                else
                {
            ...
            {
                int j4 = gridHeight / 4;
                e.Graphics.FillEllipse(dotOn ? brushLight : brushDark, ((gridWidth/2)-elementWidth*2) / 2, j4-1, (int)(elementWidth * 1.4), (int)(elementWidth * 1.3));
                e.Graphics.FillEllipse(dotOn ? brushLight : brushDark, ((gridWidth / 2) - elementWidth*2) / 2, gridHeight - j4 - 1, (int)(elementWidth * 1.4), (int)(elementWidth * 1.3));
